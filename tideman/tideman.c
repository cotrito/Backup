...
void sort_pairs(void)
{
    ...
    for( int i = 0 ; i <= pair_count -1; i++)
    {
        ...
        int c = pairs[i].winner;
        int d = pairs[i].loser;
        pairs[i].winner = pairs[big].winner;
        pairs[i].loser = pairs[big].loser;
        pairs[big].winner = c;
        pairs[big].loser = d;
...
void lock_pairs(void)
{
   ...
   /*
    printf("cantidad de candidatos %i \n",candidate_count);
